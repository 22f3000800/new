                ...
                <div class = "col-8 border" style ="height: 750px; overflow-y : scroll">
                    ...
                    <div v-for="t in transactions" class="card mt-2">
                        <div class="card-body">
                            ...
                            <p v-if="t.internal_status =='paid'" class="card-text"> Time of Delivery : {{t.delivery}} </p> 
                            <p v-if="t.internal_status =='paid'" class="card-text"> Delivery Status : {{t.delivery_status}} </p> 
